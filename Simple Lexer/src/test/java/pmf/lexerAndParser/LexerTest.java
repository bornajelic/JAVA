...
public class LexerTest {
	...
	@Test
	public void testNotNull() { //jos ne postoji nexttoken
	...
	public void testWordWithManyEscapes() {
		...
		// We expect the following stream of tokens
		Token correctData[] = { new Token(TokenType.WORD, "ab12cd3"), new Token(TokenType.WORD, "ab21cd4\\"), // this
																												// is
																												// 8-letter
																												// long,
																												// not
	...
	// Helper method for checking if lexer generates the same stream of tokens
		...
		public void testMultipartInput() {
			...
			Token ivana = new Token(TokenType.WORD, "Ivana26\\a");
			Token t1 = lexer.nextToken();
			System.out.println(ivana.toString() + " --> " + t1.toString());
			checkToken(t1, ivana);
